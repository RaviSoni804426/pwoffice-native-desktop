l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο PWOFFICE Desktop Editors!',
    welDescr: 'Εργαστείτε εκτός σύνδεσης με έγγραφα ή συνδέστε τη σουίτα στο cloud σας: PWOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα PWOFFICE cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία PWOFFICE Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός PWOFFICE cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο PWOFFICE cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
