l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο PW Office Desktop Editors!',
    welDescr: 'Εργαστείτε εκτός σύνδεσης με έγγραφα ή συνδέστε τη σουίτα στο cloud σας: PW Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα PW Office cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία PW Office Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός PW Office cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο PW Office cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
