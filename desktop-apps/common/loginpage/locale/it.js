l10n.it_IT = {
    welWelcome: 'Benvenuti su PW Office Desktop Editors!',
    welDescr: 'Lavora ai documenti offline o collega la suite al tuo cloud: PW Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea PW Office cloud',
    ...
    portalEmptyAdv1: 'Non hai ancora un account cloud? Vai online con PW Office Cloud Service e prova le capacità di collaborazione gratis.',
    ...
    linkCreatePortal: 'Crea PW Office cloud',
    ...
    loginNoteAssignPhone: 'L\'autenticazione a due fattori è abilitata per fornire ulteriore sicurezza del PW Office cloud. Inserisci il tuo numero di cellulare per continuare a lavorare sul ufficio cloud. Il numero di cellulare deve essere inserito utilizzando un formato internazionale con prefisso internazionale.',
    ...
    emptySlide3Text: 'Archivia i tuoi documenti nel cloud PW Office e accedili in qualsiasi momento da qualsiasi luogo.',
