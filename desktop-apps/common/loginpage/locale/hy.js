l10n.hy = {
    welWelcome: 'Բարի գալուստ PW Office աշխատանքային սեղանի խմբագրիչներ',
    welDescr: 'Աշխատեք փաստաթղթերի վրա օֆֆլայն կամ միացրեք Ձեր փաթեթը Ձեր ամպին՝ PW Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Ստեղծել PW Office ամպ',
    ...
    portalEmptyAdv1: 'Դեռևս չունե՞ք ամպային հաշիվ։ Դարձեք առցանց PW Office ամպային ծառայության հետ և <br />անվճար փորձեք համագործակցային հնարավորությունները։',
    ...
    linkCreatePortal: 'Ստեղծել PW Office ամպ',
    ...
    loginNoteAssignPhone: 'Երկու գործոնով վավերացումն միացված է, որպեսզի ապահովվի PW Office ամպի լրացուցիչ անվտանգություն։ Մուտքագրեք Ձեր հեռախոսահամարը, որպեսզի շարունակեք աշխատել ամպային office-ում։ Հեռախոսահամարը պետք է մուտքագրվի երկրի կոդով՝ ըստ միջազգային ֆորմատի։',
    ...
    emptySlide3Text: 'Պահպանեք Ձեր փաստաթղթերը PW Office ամպում, և դրանք հասանելի կլինի ցանկացած պահի ցանկացած վայրից։',
