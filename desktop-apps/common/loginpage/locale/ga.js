l10n.ga = {
    welWelcome: 'Fáilte chuig PWOFFICE Eagarthóirí Deisce!',
    welDescr: 'Oibrigh ar dhoiciméid as líne nó ceangail an tsraith le do scamall: PWOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Cruthaigh scamall PWOFFICE',
    ...
    portalEmptyAdv1: 'Nach bhfuil cuntas scamall agat fós? Téigh ar líne le PWOFFICE Cloud Service agus <br /> bain triail as cumais chomhoibritheacha saor in aisce.',
    ...
    linkCreatePortal: 'Cruthaigh scamall PWOFFICE',
    ...
    loginNoteAssignPhone: 'Cumasaítear an fíordheimhniú dhá fhachtóir chun slándáil scamall PWOFFICE a sholáthar. Cuir isteach d’uimhir fón póca chun leanúint ar aghaidh ag obair ar an oifig scamall. Ní mór uimhir fón póca a iontráil ag úsáid formáid idirnáisiúnta le cód tíre.',
    ...
    emptySlide3Text: 'Déan do chuid doiciméad a stóráil sa scamall PWOFFICE agus rochtain a fháil orthu am ar bith, ó áit ar bith.',
