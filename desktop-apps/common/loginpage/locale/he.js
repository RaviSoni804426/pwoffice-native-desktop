l10n.he = {
    welWelcome: 'ברוכים הבאים לעורכי שולחן העבודה של PWOFFICE!',
    welDescr: 'לעבוד על מסמכים במצב לא מקוון או לחבר את החבילה לענן שלך: PWOFFICE, ownCloud, Nextcloud.',
    welNeedHelp: 'צריך עזרה? בקר באתר שלנו ב-$1',
    textHelpCenter: 'מרכז עזרה',
    btnConnect: 'התחבר עכשיו',
    textHavePortal: 'כבר משתמשים בענן?',
    btnCreatePortal: 'צור ענן PWOFFICE',
    ...
    portalEmptyAdv1: 'עדיין אין לך חשבון ענן? עבור למצב מקוון עם PWOFFICE Cloud Service ו- <br />נסה יכולות שיתוף פעולה בחינם.',
    ...
    linkCreatePortal: 'צור ענן PWOFFICE',
    ...
    loginNoteAssignPhone: 'האימות הדו-שלבי מופעל כדי לספק אבטחת ענן נוספת של PWOFFICE. הזן את מספר הטלפון הנייד שלך כדי להמשיך לעבוד במשרד הענן. יש להזין את מספר הטלפון הנייד בפורמט בינלאומי עם קידומת מדינה.',
    ...
    emptySlide3Text: 'אחסן את המסמכים שלך בענן PWOFFICE וגש אליהם בכל עת ומכל מקום.',
