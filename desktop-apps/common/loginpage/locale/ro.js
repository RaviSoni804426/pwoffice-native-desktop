l10n.ro = {
    welWelcome: 'Bine ați venit la PW Office Desktop Editors!',
    welDescr: 'Lucrați la documente offline sau conecta suitați suitã la cloud: PW Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crearea unui cont PW Office cloud',
    ...
    portalEmptyAdv1: 'Încã nu aveți un cont Cloud? Lucrați online cu servicii cloud PW Office ți <br />încercați funcțiile de colaborare gratuit.',
    ...
    linkCreatePortal: 'Crearea unui cont PW Office cloud',
    ...
    loginNoteAssignPhone: 'Autentificarea cu doi factori este activatã ca o mãsurã suplimentarã de securitate pentru PW Office cloud. Intra-i numãrul de telefon dvs vă sã puteţi continua lucrul în oficiul cloud. Numãrul de telefon mobil trebuie introdus în format internaþional cu prefixul de țarã.',
    ...
    emptySlide3Text: 'Stocați-vă documentele în PW Office cloud și le accesati de oriunde, oricând.',
