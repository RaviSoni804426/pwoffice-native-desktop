l10n.fr = {
    welWelcome: 'Bienvenue sur PW Office Desktop Editors !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : PW Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Créer un compte Cloud PW Office',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec PW Office et essayez les capacités de gestion collaborative gratuitement.',
    ...
    linkCreatePortal: 'Créer un compte Cloud PW Office',
    ...
    emptySlide3Text: 'Stockez vos documents dans PW Office Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
