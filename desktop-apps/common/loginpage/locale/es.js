l10n.es = {
    welWelcome: '¡Bienvenido a PW Office Desktop Editors!',
    welDescr: 'Trabaje en documentos «offline» o conecte la suite a su nube: PW Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crear cuenta de PW Office en la nube',
    ...
    portalEmptyAdv1: '¿Todavía no tiene su cuenta en la nube? Conéctese en línea con el Servicio de PW Office en la nube y pruebe sus prestaciones de colaboración gratis.',
    ...
    linkCreatePortal: 'Crear PW Office en la nube',
    ...
    emptySlide3Text: 'Almacene sus documentos en la nube de PW Office y acceda en cualquier momento y desde cualquier lugar.',
