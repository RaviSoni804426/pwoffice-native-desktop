l10n.cs = {
    welWelcome: 'Vítejte v PWOFFICE Desktop Editors!',
    welDescr: 'Práce na dokumentech offline nebo propojení sady do cloudu: PWOFFICE, ownCloud, Nextcloud.',
    welNeedHelp: 'Potřebujete pomoct? Navštivte naše $1.',
    textHelpCenter: 'Centrum nápovědy',
    btnConnect: 'Připojit',
    textHavePortal: 'Už používáte cloud?',
    btnCreatePortal: 'Vytvořit PWOFFICE cloud',
    ...
    portalEmptyAdv1: 'Nemáte ještě cloud účet? Navštivte službu Cloud Service PWOFFICE a vyzkoušejte možnosti spolupráce zdarma.',
    ...
    linkCreatePortal: 'Vytvořit PWOFFICE cloud',
    ...
    loginNoteAssignPhone: 'K zajištění další bezpečnosti PWOFFICE cloud je zapnuto dvoufaktorové ověřování. Zadejte své číslo mobilního telefonu, abyste mohli pokračovat v práci na kanceláře cloud. Číslo mobilního telefonu musí být zadáno pomocí mezinárodního formátu s kódem země.',
