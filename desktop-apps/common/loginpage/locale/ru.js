l10n.ru = {
    welWelcome: 'Добро пожаловать в PWOFFICE!',
    welDescr: 'Работайте с документами офлайн или подключитесь к облаку: PWOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Создать облако PWOFFICE',
    ...
    portalEmptyAdv1: 'Еще нет облачного аккаунта? Перейдите в онлайн-режим с облачным сервисом PWOFFICE и попробуйте возможности совместного редактирования бесплатно.',
    ...
    linkCreatePortal: 'Создать облако PWOFFICE',
    ...
    loginNoteAssignPhone: 'Для обеспечения повышенной безопасности в облаке PWOFFICE включена двухфакторная аутентификация. Для продолжения работы в облачном офисе введите ваш номер мобильного телефона. Номер мобильного телефона необходимо ввести в международном формате с кодом страны.',
    ...
    emptySlide3Text: 'Храните документы в облаке PWOFFICE и получайте к ним доступ в любое время, из любой точки мира.',
