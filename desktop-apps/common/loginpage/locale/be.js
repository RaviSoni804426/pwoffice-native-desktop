l10n.be = {
    welWelcome: 'Вітаем у PW Office Desktop Editors!',
    welDescr: 'Працуйце з дакументамі ў аўтаномным рэжыме або падлучыцеся да воблака: PW Office, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Стварыць воблака PW Office',
    ...
    portalEmptyAdv1: 'У вас яшчэ няма воблачнага акаўнта? Перайдзіце на сеціўны рэжым працы з дапамогай PW Office Cloud Service і <br/> бясплатна азнаёмцеся з магчымасцямі сумеснай працы.',
    ...
    linkCreatePortal: 'Стварыць воблака PW Office',
    ...
    pshCode: 'код з SMS',
    loginNoteAssignPhone: 'Каб забяспечыць дадатковую бяспеку PW Office, уключаная двухфактарная аўтэнтыфікацыя. Каб працягнуць працу ў воблачным офісе, увядзіце нумар мабільнага тэлефона. Нумар мабільнага тэлефона павінен быць уведзены ў міжнародным фармаце з кодам краіны.',
    ...
    emptySlide3Text: 'Захоўвайце свае дакументы ў воблаку PW Office і працуйце з імі ў любы час з любога месца.',
