l10n.be = {
    welWelcome: 'Вітаем у PWOFFICE Desktop Editors!',
    welDescr: 'Працуйце з дакументамі ў аўтаномным рэжыме або падлучыцеся да воблака: PWOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Стварыць воблака PWOFFICE',
    ...
    portalEmptyAdv1: 'У вас яшчэ няма воблачнага акаўнта? Перайдзіце на сеціўны рэжым працы з дапамогай PWOFFICE Cloud Service і <br/> бясплатна азнаёмцеся з магчымасцямі сумеснай працы.',
    ...
    linkCreatePortal: 'Стварыць воблака PWOFFICE',
    ...
    pshCode: 'код з SMS',
    loginNoteAssignPhone: 'Каб забяспечыць дадатковую бяспеку PWOFFICE, уключаная двухфактарная аўтэнтыфікацыя. Каб працягнуць працу ў воблачным офісе, увядзіце нумар мабільнага тэлефона. Нумар мабільнага тэлефона павінен быць уведзены ў міжнародным фармаце з кодам краіны.',
    ...
    emptySlide3Text: 'Захоўвайце свае дакументы ў воблаку PWOFFICE і працуйце з імі ў любы час з любога месца.',
