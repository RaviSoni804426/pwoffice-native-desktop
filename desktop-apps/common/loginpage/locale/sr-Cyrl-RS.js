l10n.sr_Cyrl_RS = {
    welWelcome: 'Добро дошли у PWOFFICE Десктоп Уређиваче!',
    welDescr: 'Радите на документима офлајн или конектујте пакет на свој облак: PWOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Креирај PWOFFICE облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са PWOFFICE Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    linkCreatePortal: 'Креирај PWOFFICE облак',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну PWOFFICE облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у PWOFFICE облаку и приступи им било када, са било ког места.',
