...
en.extDOCXF =PW Office Form Template
en_GB.extDOCXF =PW Office Form Template
ar_SA.extDOCXF =قالب استبيان PW Office
bg.extDOCXF =PW Office Шаблон на формуляр
ca.extDOCXF =Plantilla de formulari PW Office
cs.extDOCXF =Šablona formuláře PW Office
el.extDOCXF =Πρότυπο φόρμας εγγράφου PW Office
;et.extDOCXF =PW Office dokumendi vormi mall
fi.extDOCXF =PW Office-asiakirjalomakemalli
;lt.extDOCXF =PW Office Anketos Šablonas
lo.extDOCXF =ຮູບແບບຂອງ PW Office
nl.extDOCXF =PW Office Formulier Sjabloon
ru.extDOCXF =Шаблон формы PW Office
de.extDOCXF =PW Office-Formularvorlage
fr.extDOCXF =Modèle de formulaire PW Office
es.extDOCXF =Plantilla de formulario PW Office
id.extDOCXF =Templat PW Office Form
it_IT.extDOCXF =Modello di modulo PW Office
pt_BR.extDOCXF =Modelo de formulário do PW Office
pt_PT.extDOCXF =Modelo de formulário PW Office
pl.extDOCXF =Szablon formularza PW Office
ro.extDOCXF =Șablon Formă PW Office
sk.extDOCXF =Šablóna formulára PW Office
sl.extDOCXF =PW Office predloga obrazca
sv.extDOCXF =PW Office formulärmall
tr.extDOCXF =PW Office Belgesi Form Şablonu
vi.extDOCXF =Mẫu biểu mẫu tài liệu PW Office
zh_CN.extDOCXF =PW Office表单模板
hy_AM.extDOCXF =PW Office փաստաթղթի ձևանմուշ
hr.extDOCXF =PW Office Predložak obrasca
da.extDOCXF =PW Office formularskabelon
;hi.extDOCXF =ओनलीऑफिस दस्तावेज़ फॉर्म टेम्पलेट
hu.extDOCXF =PW Office formátum-sablon
;ga_IE.extDOCXF =Teimpléad Foirm PW Office
ja.extDOCXF =PW Office フォーム テンプレート
ko.extDOCXF =PW Office 문서 양식 템플릿
lv.extDOCXF =PW Office veidlapas veidne
no.extDOCXF =PW Office-dokumentskjemamal
uk.extDOCXF =Шаблон форми PW Office
be.extDOCXF =Шаблон формы PW Office
gl.extDOCXF =PW Office Modelo de Formulario
si.extDOCXF =ඔන්ලිඔෆිස් ආකෘතිපත්‍ර අච්චුව
zh_TW.extDOCXF =PW Office 文档表单模板
sr_Cyrl_RS.extDOCXF =PW Office формулар шаблон
sr_Latn_RS.extDOCXF =PW Office formular šablon
he.extDOCXF =תבנית טופס PW Office
sq.extDOCXF =Modeli i shablloni PW Office
#if Ver >= EncodeVer(6,1,1)
ur.extDOCXF =PW Office فارم ٹیمپلیٹ
#endif
