...
def make():
  ...
  # fetch
  if not base.is_dir("v8"):
    base.cmd("git", ["clone", "--depth", "1", "-b", "6.0-lkgr", "https://chromium.googlesource.com/v8/v8.git", "v8"], True)
  ...
  if config.check_option("platform", "win_64"):
    ...
    base.cmd("ninja", ["-C", "out.gn/win_64/release", "v8_base", "v8_libplatform", "v8_libbase", "v8_nosnapshot", "v8_libsampler", "v8_builtins_setup", "v8_builtins_generators"])
