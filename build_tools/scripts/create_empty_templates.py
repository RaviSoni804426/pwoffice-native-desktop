...
if __name__ == '__main__':
    dirs = [
        r'D:\pwoffice-native\document-templates\new',
        r'D:\pwoffice-native\desktop-apps\win-linux\build\win_64\converter\empty',
        r'D:\pwoffice-native\build_tools\out\win_64\onlyoffice\DesktopEditors\converter\empty'
    ]
    for d in dirs:
        os.makedirs(d, exist_ok=True)
        create_blank_docx(os.path.join(d, 'new.docx'))
        create_blank_xlsx(os.path.join(d, 'new.xlsx'))
        create_blank_pptx(os.path.join(d, 'new.pptx'))
        create_blank_pdf(os.path.join(d, 'new.pdf'))
        print(f"Templates created in {d}")
